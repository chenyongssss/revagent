...
def rebuild_history_index(base) -> dict:
    ...
    try:
        ...
        for record in data.get("records", []):
            ...
            if record.get("consent") == "approved" and record.get("deidentification_status") == "approved" and record.get("deletion_status") != "deleted" and preview.is_file() and file_sha256(preview) == record.get("preview_sha256"):
