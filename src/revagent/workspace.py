...
def init_workspace(base: Path, journal: str, tex_root_arg: str, main_tex: str | None) -> Path:
    ...
    write_json(ws / "history_case_registry.json", {"version": 1, "cases": {}})
    write_json(ws / "history_quality_report.json", {"version": 1, "status": "not_published", "reason": "no_authorized_adjudicated_real_cases"})
    write_text(ws / "history_quality_report.md", "# Published History Retrieval Quality\n\nNo authorized adjudicated real-case metrics have been published.\n")
...
def migrate_workspace(base: Path, dry_run: bool = True) -> dict[str, object]:
    ...
    default_files = {
        ...
        "history_case_registry.json": {"version": 1, "cases": {}},
        "history_quality_report.json": {"version": 1, "status": "not_published", "reason": "no_authorized_adjudicated_real_cases"},
        "history_quality_report.md": "# Published History Retrieval Quality\n\nNo authorized adjudicated real-case metrics have been published.\n",
