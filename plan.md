...
| 6. Literature and external providers | Advanced partial | Consent-gated providers, normalized records, conservative retraction assertions, provenance-preserving graphs, author-gated alignment candidates, and an adjudicated alignment benchmark measuring recall@5/precision@5/MRR/zero-hit rate exist. Real independently labelled alignment cases, Semantic Scholar, broader retraction coverage, and novelty-risk analysis remain missing. |
...
4. Collect real independently adjudicated claim-alignment cases and publish
   measured quality before specifying any novelty-risk summary or release gate.
